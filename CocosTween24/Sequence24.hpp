...
public:
    ...
    Sequence24Ptr addTweens(IInterval24Ptr tween);
    Sequence24Ptr addTweens(const std::vector<IInterval24Ptr> &tweens);

    template <class... Args>
    Sequence24Ptr addTweens(IInterval24Ptr tween, Args... args)
    {
        addTweens(tween);
        addTweens(args...);
